...
function init(settings) {
  ...
  options = {
    ...
    dev: false,
    entry: {
      file: "/./_app/start-ba39dc28.js",
      css: ["/./_app/assets/start-230d6437.css"],
      js: ["/./_app/start-ba39dc28.js", "/./_app/chunks/vendor-2f7c43bc.js"]
    },
    fetched: void 0,
    floc: false,
...
var metadata_lookup = {"src/routes/__layout.svelte": {"entry": "/./_app/pages/__layout.svelte-57ecf99b.js", "css": ["/./_app/assets/pages/__layout.svelte-52d4f4fe.css"], "js": ["/./_app/pages/__layout.svelte-57ecf99b.js", "/./_app/chunks/vendor-2f7c43bc.js"], "styles": null}, ".svelte-kit/build/components/error.svelte": {"entry": "/./_app/error.svelte-d4d2d58c.js", "css": [], "js": ["/./_app/error.svelte-d4d2d58c.js", "/./_app/chunks/vendor-2f7c43bc.js"], "styles": null}, "src/routes/index.svelte": {"entry": "/./_app/pages/index.svelte-9a85afd5.js", "css": ["/./_app/assets/pages/index.svelte-ef393222.css"], "js": ["/./_app/pages/index.svelte-9a85afd5.js", "/./_app/chunks/vendor-2f7c43bc.js"], "styles": null}, "src/routes/about.svelte": {"entry": "/./_app/pages/about.svelte-3ef13b01.js", "css": ["/./_app/assets/pages/about.svelte-7c88e487.css"], "js": ["/./_app/pages/about.svelte-3ef13b01.js", "/./_app/chunks/vendor-2f7c43bc.js"], "styles": null}, "src/routes/todos/index.svelte": {"entry": "/./_app/pages/todos/index.svelte-2908adeb.js", "css": ["/./_app/assets/pages/todos/index.svelte-f4d9bf4b.css"], "js": ["/./_app/pages/todos/index.svelte-2908adeb.js", "/./_app/chunks/vendor-2f7c43bc.js"], "styles": null}};
...
<section class="${"text-gray-600 body-font svelte-1lg7s1b"}"><div class="${"container px-5 py-24 mx-auto flex flex-wrap"}"><div class="${"flex flex-wrap -m-4"}"><div class="${"p-4 lg:w-1/2 md:w-full"}"><div class="${"flex border-2 rounded-lg border-gray-200 border-opacity-50 p-8 sm:flex-row flex-col"}"><div class="${"w-16 h-16 sm:mr-8 sm:mb-0 mb-4 inline-flex items-center justify-center rounded-full bg-pink-100 text-pink-500 flex-shrink-0"}"><svg fill="${"none"}" stroke="${"currentColor"}" stroke-linecap="${"round"}" stroke-linejoin="${"round"}" stroke-width="${"2"}" class="${"w-8 h-8"}" viewBox="${"0 0 24 24"}"><path d="${"M22 12h-4l-3 9L9 3l-3 9H2"}"></path></svg></div>
        ...
        <div class="${"p-4 lg:w-1/2 md:w-full"}"><div class="${"flex border-2 rounded-lg border-gray-200 border-opacity-50 p-8 sm:flex-row flex-col"}"><div class="${"w-16 h-16 sm:mr-8 sm:mb-0 mb-4 inline-flex items-center justify-center rounded-full bg-pink-100 text-pink-500 flex-shrink-0"}"><svg fill="${"none"}" stroke="${"currentColor"}" stroke-linecap="${"round"}" stroke-linejoin="${"round"}" stroke-width="${"2"}" class="${"w-10 h-10"}" viewBox="${"0 0 24 24"}"><path d="${"M20 21v-2a4 4 0 00-4-4H8a4 4 0 00-4 4v2"}"></path><circle cx="${"12"}" cy="${"7"}" r="${"4"}"></circle></svg></div>
            <div class="${"flex-grow"}"><h2 class="${"text-gray-900 text-lg title-font font-medium mb-3"}">The Catalyzer</h2>
              <p class="${"leading-relaxed text-base"}">Blue bottle crucifix vinyl post-ironic four dollar toast vegan taxidermy. Gastropub indxgo juice poutine.</p>
              <a class="${"mt-3 text-pink-500 inline-flex items-center"}">Learn More
                <svg fill="${"none"}" stroke="${"currentColor"}" stroke-linecap="${"round"}" stroke-linejoin="${"round"}" stroke-width="${"2"}" class="${"w-4 h-4 ml-2"}" viewBox="${"0 0 24 24"}"><path d="${"M5 12h14M12 5l7 7-7 7"}"></path></svg></a></div></div></div></div></div>
  </section>`;
});
