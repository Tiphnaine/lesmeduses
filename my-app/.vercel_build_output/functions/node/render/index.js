...
function init(settings) {
  ...
  options = {
    ...
    dev: false,
    entry: {
      file: "/./_app/start-eac436a3.js",
      css: ["/./_app/assets/start-230d6437.css"],
      js: ["/./_app/start-eac436a3.js", "/./_app/chunks/vendor-6d0fc5d6.js"]
    },
    fetched: void 0,
    floc: false,
...
var metadata_lookup = {"src/routes/__layout.svelte": {"entry": "/./_app/pages/__layout.svelte-1e809302.js", "css": ["/./_app/assets/pages/__layout.svelte-52d4f4fe.css"], "js": ["/./_app/pages/__layout.svelte-1e809302.js", "/./_app/chunks/vendor-6d0fc5d6.js"], "styles": null}, ".svelte-kit/build/components/error.svelte": {"entry": "/./_app/error.svelte-0c032e27.js", "css": [], "js": ["/./_app/error.svelte-0c032e27.js", "/./_app/chunks/vendor-6d0fc5d6.js"], "styles": null}, "src/routes/index.svelte": {"entry": "/./_app/pages/index.svelte-6d73c2e0.js", "css": ["/./_app/assets/pages/index.svelte-ef393222.css"], "js": ["/./_app/pages/index.svelte-6d73c2e0.js", "/./_app/chunks/vendor-6d0fc5d6.js"], "styles": null}, "src/routes/about.svelte": {"entry": "/./_app/pages/about.svelte-71ac27b3.js", "css": ["/./_app/assets/pages/about.svelte-7c88e487.css"], "js": ["/./_app/pages/about.svelte-71ac27b3.js", "/./_app/chunks/vendor-6d0fc5d6.js"], "styles": null}, "src/routes/todos/index.svelte": {"entry": "/./_app/pages/todos/index.svelte-9fad7be1.js", "css": ["/./_app/assets/pages/todos/index.svelte-f4d9bf4b.css"], "js": ["/./_app/pages/todos/index.svelte-9fad7be1.js", "/./_app/chunks/vendor-6d0fc5d6.js"], "styles": null}};
...
<section class="${"svelte-1lg7s1b"}"><h1 class="${"svelte-1lg7s1b"}"><div class="${"welcome svelte-1lg7s1b"}"><picture><img src="${"https://i.imgur.com/ugjoMVJ.png"}" alt="${"Les M\xE9duses"}"></picture></div>
	...
	<h2>try editing <strong>src/routes/index.svelte</strong></h2></section>
<section class="${"text-gray-600 body-font svelte-1lg7s1b"}"><div class="${"container px-5 py-24 mx-auto"}"><div class="${"text-center mb-20"}"><h1 class="${"sm:text-3xl text-2xl font-medium title-font text-gray-900 mb-4 svelte-1lg7s1b"}">Who we are</h1>
      <p class="${"text-base leading-relaxed xl:w-2/4 lg:w-3/4 mx-auto text-gray-500s"}">Les M\xE9duses is involved in various working groups dealing with Sexual and Sexist Violence (SSV). Each working group analyses the existing dispositives and works with the school administration in question to propose recommendations.</p>
