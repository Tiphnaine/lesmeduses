      ...
      <dl class="space-y-10 md:space-y-0 md:grid md:grid-cols-2 md:gap-x-8 md:gap-y-10">
        <div class="relative">
          <dt>
            ...
            <h2 class="ml-16 text-lg leading-6 font-medium font-sans uppercase">Raise awareness and overcome taboos</h2>
          </dt>
        ...
        <div class="relative">
          <dt>
            ...
            <h2 class="ml-16 text-lg leading-6 font-medium font-sans uppercase">Support Structures</h2>
          </dt>
          <dd class="mt-2 ml-16 text-base text-gray-500">
        ...
        <div class="relative">
          <dt>
            ...
            <h2 class="ml-16 text-lg leading-6 font-medium font-sans uppercase">Student training</h2>
          </dt>
          <dd class="mt-2 ml-16 text-base text-gray-500">
        ...
        <div class="relative">
          <dt>
            ...
            <h2 class="ml-16 text-lg leading-6 font-medium font-sans uppercase">SSV in the working environment</h2>
          </dt>
          <dd class="mt-2 ml-16 text-base text-gray-500">
