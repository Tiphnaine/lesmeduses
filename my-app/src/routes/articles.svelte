      ...
      <div class="flex flex-wrap -m-4">
        <div class="p-4 lg:w-1/3">
          <div class="h-full bg-gray-100 bg-opacity-75 px-8 pt-16 pb-24 rounded-lg overflow-hidden text-center relative">
            ...
            <h1 class="title-font sm:text-2xl text-xl font-medium text-gray-900 mb-3">The gendered perception of the naked body</h1>
            ...
            <a href="/naked" class="text-indigo-500 inline-flex items-center">Learn More
